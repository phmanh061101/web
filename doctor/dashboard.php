...
?>
						<div class="pull-left">
							...
							<small class="text-color">Lịch Hẹn Mới</small>
						</div>
						<span class="pull-right big-icon watermark"><i class="fa fa-paperclip"></i></span>
					</div>
					<footer class="widget-footer bg-warning">
						<a href="new-appointment.php"><small> Chi Tiết </small></a>
...
?>
						<div class="pull-left">
							...
							<small class="text-color">Lịch Đã Nhận</small>
						</div>
						<span class="pull-right big-icon watermark"><i class="fa fa-ban"></i></span>
					</div>
					<footer class="widget-footer bg-success">
						<a href="approved-appointment.php"><small> Chi Tiết</small></a>
...
?>
							...
							<small class="text-color">Lịch Đã Huỷ</small>
						</div>
						<span class="pull-right big-icon watermark"><i class="fa fa-unlock-alt"></i></span>
					</div>
					<footer class="widget-footer bg-danger">
						<a href="cancelled-appointment.php"><small> Chi tiết</small></a>
...
?>
							...
							<small class="text-color">Tổng Số Lịch Hẹn</small>
						</div>
						<span class="pull-right big-icon watermark"><i class="fa fa-file-text-o"></i></span>
					</div>
					<footer class="widget-footer bg-primary">
						<a href="all-appointment.php"><small> Chi Tiết</small></a>
