      ...
      <div class="col-md-12">
        <div class="widget">
          <header class="widget-header">
            <h3 class="widget-title">Thông Tin Cá Nhân</h3>
...
{               ?>
            <form class="form-horizontal" method="post">
              <div class="form-group">
                <label for="exampleTextInput1" class="col-sm-3 control-label">Mã Bác Sĩ:</label>
                <div class="col-sm-9">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label for="email2" class="col-sm-3 control-label">Số Điện Thoại:</label>
                <div class="col-sm-9">
              ...
              <div class="form-group">
                <label for="email2" class="col-sm-3 control-label">Khoa:</label>
                <div class="col-sm-9">
...
{               ?>
        <option value="<?php  echo htmlentities($row1->ID);?>"><?php  echo htmlentities($row1->Specialization);?></option><?php $cnt=$cnt+1;}} ?> 
              ...
              <div class="form-group">
                <label for="email2" class="col-sm-3 control-label">Ngày Đăng Kí:</label>
                <div class="col-sm-9">
             ...
             <?php $cnt=$cnt+1;}} ?>
             <div class="form-group">
                <label for="email2" class="col-sm-3 control-label">QR Code:</label>
                <div class="col-sm-9">
                  <img src="images/qr_images/<?php echo $row->qrcode?>" alt="QrCode">
                </div>
              </div>
              <div class="row">
                <div class="col-sm-9 col-sm-offset-3">
                  <button type="submit" class="btn btn-success" name="submit">Cập Nhật</button> 
                  <button type="submit" class="btn btn-success"  name="qrcodesubmit"><a href="../../qrcode/qrcode/index.php">Tạo QRCode</a></button> 
                </div>
