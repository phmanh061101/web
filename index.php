...
if (isset($_POST['submit'])) {
    ...
    if (!preg_match("/^[[a-zA-ZÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚĂĐĨŨƠàáâãèéêìíòóôõùúăđĩũơƯĂẠẢẤẦẨẪẬẮẰẲẴẶẸẺẼỀỀỂưăạảấầẩẫậắằẳẵặẹẻẽềềểỄỆỈỊỌỎỐỒỔỖỘỚỜỞỠỢỤỦỨỪễệỉịọỏốồổỗộớờởỡợụủứừỬỮỰỲỴÝỶỸửữựỳỵỷỹ\s]{1,}$/", $name)) {
        echo '<script>alert("Nhập sai tên . Vui lòng nhập lại");</script>';
    } elseif (!preg_match("/^[0]{1}[9|3|7]{1}[0-9]{8}$/", $mobnum)) {
        echo '<script>alert("Nhập sai số điện thoại. Vui lòng nhập lại");</script>';
    } elseif ($appdate <= $cdate) {
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        ...
                        if ($query->rowCount() > 0) {
                            foreach ($results as $row) {               ?>
                                ...
                                Mang đến cho mọi khách hàng nhiều hơn những gì họ yêu cầu về chất lượng, sự lựa chọn, giá trị đồng tiền 
                                và dịch vụ khách hàng, bằng cách hiểu thị hiếu và sở thích địa phương, đồng thời không ngừng đổi mới để cuối cùng mang đến trải nghiệm mua sắm trang sức chưa từng có."; ?>.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-12 mx-auto">
                        <div class="booking-form">
                            ...
                            <h2 class="text-left mb-lg-3 mb-2" style=" margin-left:-235px;">Đặt Lịch Khám</h2>
                            ...
                            <form role="form" method="post">
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <input type="text" name="name" id="name" class="form-control" placeholder="Họ Tên" required='true'>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <input type="telephone" name="phone" id="phone" class="form-control" placeholder="Số Điện Thoại" maxlength="10">
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-4 col-6 mx-auto">
                                        <button type="submit" class="form-control" name="submit" id="submit-button">Đặt Lịch</button>
