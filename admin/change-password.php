      ...
      <div class="col-md-12">
        <div class="widget">
          <header class="widget-header">
            <h3 class="widget-title">Đổi Mật Khẩu</h3>
          </header><!-- .widget-header -->
          <hr class="widget-separator">
          <div class="widget-body">
            
            <form class="form-horizontal" onsubmit="return checkpass();" name="Đổi Mật Khẩu" method="post">
              <div class="form-group">
                <label for="exampleTextInput1" class="col-sm-3 control-label">Mật Khẩu Hiện Tại:</label>
                <div class="col-sm-9">
                  <input type="password" class="form-control" name="password" id="password"required='true'>
                </div>
              </div>
              <div class="form-group">
                <label for="email2" class="col-sm-3 control-label">Mật Khẩu Mới:</label>
                <div class="col-sm-9">
                  <input type="password" class="form-control" name="newpassword"  class="form-control" required="true">
                </div>
              </div>
              <div class="form-group">
                <label for="email2" class="col-sm-3 control-label">Nhập Lại Mật Khẩu:</label>
                <div class="col-sm-9">
              ...
              <div class="row">
                <div class="col-sm-9 col-sm-offset-3">
                  <button type="submit" class="btn btn-success" name="submit">Đổi</button>
                </div>
              </div>
            </form>
          </div><!-- .widget-body -->
