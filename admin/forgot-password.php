...
<body class="simple-page">
	...
	<h4 class="form-title m-b-xl text-center">Mật Khẩu Mới</h4>
...
<div class="form-group">
 <input class="form-control" type="password" name="confirmpassword" placeholder="Nhập lại " required="true" />
</div>
...
<div class="simple-page-footer">
	<p style="color: white">Bạn đã có tài khoản ?<a href="login.php"> Đăng Nhập Ngay</a></p>
